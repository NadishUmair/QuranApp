    ...
    <div className="flex flex-wrap h-[100vh] ">
      ...
      <div className=" w-[80%] p-3 ml-[20%] ">
        ...
        <div className="lg:flex lg:flex-wrap md:flex md:flex-wrap   gap-3 lg:h-[30vh] md:h-[30vh] sm:w-full mb-4 ">
          ...
          <div className="py-2  lg:w-[20%] flex flex-wrap gap-2 w-full bg-yellow-500 rounded-lg p-2 text-white   ">
            <BsFlower1 className="text-3xl  " />
            <h1 className="text-xl">Daily Hadith</h1>
            <p className="text-md">
              Lorem, ipsum dolor sit amet consectetur adipissm, iure?
